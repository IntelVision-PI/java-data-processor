...
public static void main(String[] args) {
    ...
    while (continuar) {
        ...
        switch (leitor) {
            case 1:
                monitorarComponentes(random);
                break;
            case 2:
                System.out.println("Status de Conexão com o Banco de Dados: CONECTADO");
                break;
            case 3:
                System.out.println("Status dos Dados do Bucket: NÃO ESTÁ RECEBENDO DADOS");
                break;
            case 4:
                continuar = false;
                break;
